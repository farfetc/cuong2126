...
const htmlSignupAccount = (token) => {
  return `<div>
    ...
    <h2 style="padding: 10px 0; margin-bottom: 10px;">
        Xin chào anh (chị),<br />
        Mã xác nhận đăng ký tài khoản cho website TuTu Store của anh (chị).<br />
        Cảm ơn vì đã ghé thăm TuTu Store <3
    </h2>
...
const htmlResetPassword = (token) => {
  return `<div>
    ...
    <h2 style="padding: 10px 0; margin-bottom: 10px;">
        Xin chào anh (chị),<br />
        Cửa hàng TuTu Store đã nhận được yêu cầu lấy lại mật khẩu từ quý khách.<br />
